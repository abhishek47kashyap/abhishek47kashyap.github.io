...
CNNs being clearly superior, with epoch 1 reconstructions having a lower training loss than fully-connected's epoch 20 loss, we'll move forward with CNNs.

## Interpolating in latent space
Let's take two numbers, and interpolate between them .. _in the latent space_. We will visualize one number gradually "morph" into the other.
