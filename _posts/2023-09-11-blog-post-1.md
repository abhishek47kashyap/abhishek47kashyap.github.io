...
![Autoencoder_schema](https://en.wikipedia.org/wiki/Autoencoder#/media/File:Autoencoder_schema.png)

![Autoencoder_schema](https://upload.wikimedia.org/wikipedia/commons/thumb/2/28/Autoencoder_schema.png/400px-Autoencoder_schema.png)
